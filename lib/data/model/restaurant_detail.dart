...
class RestaurantDetailModels {
  RestaurantDetailModels({
    required this.error,
  ...
  factory RestaurantDetailModels.fromRawJson(String str) =>
      RestaurantDetailModels.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory RestaurantDetailModels.fromJson(Map<String, dynamic> json) =>
      RestaurantDetailModels(
        error: json["error"],
